...
if sidebar == pages[10]:
    image_urls = [
        ...
        ("https://photos.app.goo.gl/UW2MoaRbNNtAFc3k8", "Delphi"),
        ("https://photos.app.goo.gl/kdoBuH4QQHf5AKXy9", "Ermass"),
        ("https://photos.app.goo.gl/q8txjLaNmWH9yhB8A", "Petrettini"),
        ("https://photos.app.goo.gl/WzoTSoPnm31HwxRa6", "Petrettini"),
        ("https://photos.app.goo.gl/SAJGePxCMzF3iV6P7", "Boat"),
        ("https://photos.app.goo.gl/ivdLbNVoVQft9yat6", "Synagogue Corfu"),
        ("https://photos.app.goo.gl/W5qTtjgaqjAVf1QZ7", "Ferry"),
        ("https://photos.app.goo.gl/EKtqVNyXnDg2V5aKA", "Corfu town"),
        ("https://photos.app.goo.gl/7mn26cs8x4FnCYyq8", "Ostuni"),
        ("https://photos.app.goo.gl/mVPJUKW5gzdB9jU99", "Ferry Bari"),
    ]
