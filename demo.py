...
if sidebar==pages[10]:
    ...
    st.markdown(f'<a href="https://docs.google.com/document/d/165F-R3qm1RqhEpT7p1xB6oqRg3C_9l8VB-Bz-cO7gXg/edit?tab=t.0">📄 Ouvrir la présentation</a>', unsafe_allow_html=True)
